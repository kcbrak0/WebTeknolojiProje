<?php 
	...
	if ( filter_var($uname, FILTER_VALIDATE_EMAIL) ){ 
		if(isset($_POST['submit'])){
			if($uname=="g191210021@sakarya.edu.tr"){
				if($pass=="g191210021"){
					$error="";
					$success="Hoşgeldiniz";
    ...
    <div class="container">
        <header class="header py-3">
            <div class="row flex-nowrap justify-content-between align-items-center">
              ...
              <div class="col-4 d-flex justify-content-end align-items-center">
                ...
                <a class="btn btn-sm btn-outline-secondary" href="giris.php">Üye Girişi</a>
              </div>
            </div>
          </header>
        ...
        <div class="nav-scroller py-1 mb-2">
          <nav class="nav d-flex justify-content-between">
            ...
            <a class="p-2 link-secondary" href="ilgialani.php">İlgi Alanlarım</a>
    ...
    <main class="container">
      ...
      <form action="kontrol.php" method="post">
        <div class="form-input">
          ...
          <input type="text" name="pass" value="" placeholder="Şifre Giriniz" required><br />
